class MultiplicacionBodyControllers {
    constructor(model) {
        this.model = model;
    }
    ...
    async crear(req, res){
        try {
            ...
            const data = await this.model.crear(numero1, numero2, resultado, 'multiplicacion', 'body');
    ...
    async listar(req, res) {
        try {
            const data = await this.model.listar('multiplicacion', 'body');
...
module.exports = MultiplicacionBodyControllers;
