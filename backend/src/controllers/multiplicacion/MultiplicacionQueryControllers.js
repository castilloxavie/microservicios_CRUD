class MultiplicacionQueryControllers {
    constructor(model) {
        this.model = model
    }
    ...
    async crear(req, res) {
        try {
            ...
            const data = await this.model.crear(numero1, numero2, resultado, 'multiplicacion', 'query');
            console.log("Operacion de multiplicacion creada:", data);
    ...
    async listar(req, res){
        try {
            const data = await this.model.listar('multiplicacion', 'query');
            console.log("Operaciones de multiplicacion listadas:", data);
    ...
    async actualizar(req, res){
        try {
            ...
            console.log("Operacion de multiplicacion actualizada:", respuesta);
    ...
    async eliminar(req, res){
        try {
            ...
            console.log("Operacion de multiplicacion eliminada:", respuesta);
            res.status(200).json(respuesta);
        } catch (error) {
...
module.exports = MultiplicacionQueryControllers;
