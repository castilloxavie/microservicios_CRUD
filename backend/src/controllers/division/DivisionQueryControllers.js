class DivisionQueryControllers {
    constructor(model) {
        this.model = model
    }
    ...
    async crear(req, res) {
        try {
            ...
            const data = await this.model.crear(numero1, numero2, resultado, 'division', 'query');
    ...
    async listar(req, res){
        try {
            const data = await this.model.listar('division', 'query');
...
module.exports = DivisionQueryControllers;
