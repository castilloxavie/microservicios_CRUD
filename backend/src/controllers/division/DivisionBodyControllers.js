class DivisionBodyControllers {
    ...
    async crear(req, res){
        try {
            ...
            const data = await this.model.crear(numero1, numero2, resultado, 'division', 'body');
    ...
    async listar(req, res) {
        try {
            const data = await this.model.listar('division', 'body');
...
module.exports = DivisionBodyControllers;
