class RestaBodyControllers {
    ...
    async crear(req, res){
        try {
            ...
            const data = await this.model.crear(numero1, numero2, resultado, 'resta', 'body');
    ...
    async listar(req, res) {
        try {
            const data = await this.model.listar('resta', 'body');
...
module.exports = RestaBodyControllers;