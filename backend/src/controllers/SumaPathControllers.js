class SumaPathControllers {
    ...
    async crear(req, res){
        try {
            ...
            const data = await this.model.crear(numero1, numero2, resultado, 'suma', 'path');
    ...
    async listar(req, res){
        try {
            const data = await this.model.listar('suma', 'path');
...
module.exports = SumaPathControllers;